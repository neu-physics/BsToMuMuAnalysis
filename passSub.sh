...
python submitSampleToCondor.py --outputDir zmumu_200PU_D39_$1 --inputTXTfile MuonIsolationAnalyzer/data/filelists/zmumu_files_D39_200PU.txt --nFilesPerJob 20
sleep 15
python submitSampleToCondor.py --outputDir ttbar_200PU_D39_$1 --inputTXTfile MuonIsolationAnalyzer/data/filelists/ttbar_files_D39_200PU.txt --nFilesPerJob 20
sleep 15
...
#python submitSampleToCondor.py --outputDir bmumu_0PU_$1 --inputTXTfile MuonIsolationAnalyzer/data/filelists/bmumu_files_xrd_NoPU.txt --nFilesPerJob 10
#sleep 15
#python submitSampleToCondor.py --outputDir bmumu_200PU_$1 --inputTXTfile MuonIsolationAnalyzer/data/filelists/bmumu_files_xrd_200PU.txt --nFilesPerJob 10
